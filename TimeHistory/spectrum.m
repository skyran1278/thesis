...
% pick 7 time history
filenames = [
  "RSN68_SFERN_PEL090", "RSN125_FRIULI.A_A-TMZ270", "RSN1111_KOBE_NIS000", "RSN848_LANDERS_CLW-LN", "RSN1787_HECTOR_HEC000", "RSN174_IMPVALL.H_H-E11140", "RSN725_SUPER.B_B-POE360"
];

NM = [
  1.336, 0.951, 0.620, 1.051, 1.115, 0.806, 1.000
];

% pick 3 time history
% filenames = [
%   "RSN125_FRIULI.A_A-TMZ000", "RSN767_LOMAP_G03000", "RSN1148_KOCAELI_ARE000"
% ];
%
% NM = [
%   1.212, 0.863, 1
